...
'train_model_mort_redo.ipynb', 'train_model_STS_MMOM_redo.ipynb', and so on (each outcome is a different notebook, but they are very similar, only needs to specify the outcome of interest
